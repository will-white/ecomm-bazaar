...
const users: (typeof schema.user.$inferInsert)[] = [
  {
    ...
    // password: '12345',
    password: '$2a$12$hjc0OVZAQq.cCg3P8zE4MuYpbpfniYaxpZNV7jk5QcMseYc95bJWW',
  ...
  },
  {
    ...
    // password: 'abc123',
    password: '$2a$12$t1K5tz.kcdMhAf7L21EUCOA4RZzOG1VZiEbdcQvExx8mcLBUurOAe',
  ...
  },
  {
    ...
    password: '$2a$12$6a9L3V7./Skv1F60O77Ave.dVtoWxWemrodD.1VCLggPYoa/xSZGa',
